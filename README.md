...
Past events can still open in the event detail page. The best solution is not fixed yet. A future change should decide the expected behavior, such as showing a past-event notice, hiding registration actions, or redirecting to an archive view.
